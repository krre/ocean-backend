...
CREATE INDEX IF NOT EXISTS forum_poll_answers_topic_id_idx ON forum_posts(topic_id);
...
CREATE INDEX IF NOT EXISTS forum_poll_votes_topic_id_idx ON forum_poll_votes(topic_id);
CREATE INDEX IF NOT EXISTS forum_poll_votes_answer_id_idx ON forum_poll_votes(answer_id);
CREATE INDEX IF NOT EXISTS forum_poll_votes_user_id_idx ON forum_poll_votes(user_id);
